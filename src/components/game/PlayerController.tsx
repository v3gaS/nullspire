...
export function PlayerController() {
  ...
  useFrame((_, dt) => {
    ...
    if (nearGround) {
      ...
      if (wasAirborne.current && spawnProtect.current <= 0) {
        ...
        if (!grace && impact > 14) {
          ...
          playSfx("/assets/audio/kenney-fps/land.ogg", 0.4);
          ...
          combatFx.pushImpact(
            new THREE.Vector3(pos.x + 0.4, 0.22, pos.z - 0.3),
            "#ffb347",
          );
          combatFx.pushImpact(
            new THREE.Vector3(pos.x - 0.35, 0.18, pos.z + 0.25),
            "#94a3b8",
          );
          combatFx.pushImpact(
            new THREE.Vector3(pos.x + 0.15, 0.2, pos.z + 0.35),
            "#ff7a18",
          );
          combatFx.pushBoom(
    ...
    const airControl = nearGround ? 1 : 0.86;
