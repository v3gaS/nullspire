...
- Corner HUD: HEALTH/ARMOR numbers, weapon+ammo+orange slots, kill feed + FRAGS
- Hangar light: brighter skylight wash, lighter fog/floor, orange+dual green runway
- Floating emissive cube loot + weapon pickup cubes; plaza cover crates + rings
- Soft HangarBloom (medium/high) + tall wall light strips into mid-canyon pillars
- Orange Void RL / Scatter; thicker Rail/Arc; scroll+Q weapon cycle; 8s drop shield
- Blocky hostiles/dummies; boss skylights + orange wash; FOV 80/92; snappier move
...
- Boss HUD restyle; hotter vignette/land dust/abilities; Singularity orange boom
- Mid-block: harder Void kick/booms, fatter SMG/Scatter/Rail/Arc, orange jump pads
- Bigger hit markers + land dust; denser barrels; thicker crosshair; multi-kill XL
- Visual QA (hard-refresh): chunky SMG, orange slot glow, corner HUD, orange lane, cubes, bloom
- Live: https://nullspire-amber.vercel.app
